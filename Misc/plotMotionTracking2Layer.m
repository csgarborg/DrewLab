...
%         if exist('C:\Workspace\Code\DrewLab\movementDataLogSqueeze.mat','file')
%             load('C:\Workspace\Code\DrewLab\movementDataLogSqueeze.mat');
%             if any(strcmp(moveDataMat(:,1),[movementData.runDate '_' movementData.runNumber]))
%                 dupRow = find(strcmp(moveDataMat(:,1),[movementData.runDate '_' movementData.runNumber]));
...
%         end
%         save('C:\Workspace\Code\DrewLab\movementDataLogSqueeze.mat','moveDataMat');
%     end
end
end
