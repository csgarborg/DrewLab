function compareDigitalREMEventsFromExcel(excelPath)
...
function [coeff,score,latent,explained,corrMatrix,signalNames,nSignals] = ...
    computeDigitalSignalsFromREM(tdmsPath, segments)
...
%% Build matrix (same as your pipeline)
