function generateSleepScorePlotDataRL(dateList)

Batch_Preprocess_TDMS_AnalogDataRL_SF(dateList)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function Batch_Preprocess_TDMS_AnalogDataRL_SF(dateList, forceSpectrogram, forceForceProcessing)
...
emgRightRaw = td.Analog_Data.Right_EMG(:)';
emgLeftRaw  = td.Analog_Data.Left_EMG(:)';
...
ecogRaw      = ecogRaw(1:L);
emgRightRaw  = emgRightRaw(1:L);
emgLeftRaw   = emgLeftRaw(1:L);
...
ProcData.EMG.RightPower  = rightPowerDS;
...
% Check for NaNs and linear interpolate
ecogRaw = fillmissing(ecogRaw,'linear');
...
% Check for NaNs and linear interpolate
emgRaw = fillmissing(emgRaw,'linear');
...
% Check for NaNs and linear interpolate
forceRaw = fillmissing(forceRaw,'linear');
...
% replace outliers with nan and linear interpolate
force(abs(force - median(force,"omitnan")) > 5) = NaN;
